...
class TodoControllerTest {
    ...
    void updatedAtChangesOnUpdate() throws Exception {
        ...
        // small delay so updatedAt is actually different
        Thread.sleep(100);
    ...
    void getAllTodos() throws Exception {
        mvc.perform(post("/todos").contentType(MediaType.APPLICATION_JSON).content("{\"title\":\"Task 1\"}"));
        mvc.perform(post("/todos").contentType(MediaType.APPLICATION_JSON).content("{\"title\":\"Task 2\"}"));
